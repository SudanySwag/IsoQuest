...
local input_arg = "screenshots/VRAM8.BMP"
...
display.print(bmp_info)

for y=0, bmp.height-1 do
	for x=0, bmp.width-1 do
		local r,g,b,a = bmp:get_pixel(x,y)
		if a == 0 then
			display.print("\027[0m")
		elseif r and use_24bit then
			display.print(rgb_to_ansi_24bit(r,g,b))
		elseif r then
			display.print(rgb_to_ansi_256(r,g,b))
		end
		display.print(" ")
	end
	display.print("\027[0m\n")
